      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <button
            ...
            className="p-4 rounded-2xl bg-gradient-to-br from-stone-900 to-amber-950 border border-amber-500/40 hover:border-amber-400 text-left transition flex flex-col justify-between group shadow-md col-span-2"
          >
            <div className="flex items-center justify-between w-full mb-3">
              ...
              <span className="px-2 py-0.5 text-[10px] font-black bg-amber-500 text-stone-950 rounded-full tracking-wider">
                🎬 NEW MOVIE MODE
              </span>
            </div>
            <div>
              <h4 className="font-black text-amber-200 text-base group-hover:text-amber-400 transition">เรียนศัพท์ & สแลงจากหนัง</h4>
              <p className="text-xs text-stone-400 mt-1">ฟังบทพูดซับไตเติ้ล เจาะลึกคำศัพท์และสแลงที่ฝรั่งใช้จริงในภาพยนตร์</p>
            </div>
          </button>
